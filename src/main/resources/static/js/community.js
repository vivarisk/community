        ...
        success: function (response){
            if(response.code == 200){
                ...
                if(response.code == 2003){
                    ...
                    if(isAccepted){
                        window.open("https://gitee.com/oauth/authorize?client_id=23b2a37d17bb111cade9bfee453f75c842e724591b62c7c0046d046e8ef8f54b&redirect_uri=http://localhost:8887/callback&response_type=code");
